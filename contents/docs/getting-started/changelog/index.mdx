...
<Release version="1.10.1" title="Accessibility Improvements and Bug Fixes">
  <Changes type="fixed">
...
<Release version="1.10.0" title="Sidebar Improvements and Mobile TOC Enhancements">
  <Changes type="added">
...
<Release version="1.9.0" title="New Keyboard component to show keyboard shortcut on docs page">
  <Changes type="added">
...
<Release version="1.8.5" title="Add sponsor card on single docs page">
  <Changes type="added">
    - Expandables Leftbar
...
<Release version="1.8.0" title="Now looks more modern and clean which is a big change in layout and design">
  <Changes type="added">
    - Social footer
    - Toggle group
...
<Release version="1.7.0" title="Remove the old function in the search dialog and replace it with a new and more optimal feature">
  <Changes type="added">
...
<Release version="1.6.0" title="New Feature Card Groups with arrays for more Flexible Content">
  <Changes type="added">
...
<Release version="1.5.0" title="Minor Update - improved features and responsiveness on all devices">
  <Changes type="added">
...
<Release version="1.4.2" title="Complex Content for Accordion Component props {children}">
  <Changes type="added">
...
<Release version="1.4.0" title="Floating Button Version with Dynamic Tag {version} on Changelog page">
  <Changes type="added">
...
<Release version="1.3.8" title="Responsive Table of Content">
  <Changes type="added">
...
<Release version="1.3.6" title="Appears more modern editor for Docu Play">
...
<Release version="1.3.5" title="It's Easy to Write Markdown with Playground">
...
<Release version="1.3.1" title="Snippet Feature to Easily Write Markdown and Call DocuBook Components">
...
<Release version="1.3.0" title="Release Note Feature to Make it Easier to Write Changelogs">
  <Changes type="added">
...
<Release version="1.2.0" title="New Accordion Component: Support content plain text, html and all markdown component">
  <Changes type="added">
...
<Release version="1.1.0" title="Minor Update: Easily manage set up with docu.json">
  <Changes type="added">
    - Add docu.json file
...
<Release version="1.0.7" title="Easily updates your DocuBook Version with CLI npx update_docu">
  <Changes type="added">
...
<Release version="1.0.6" title="New Components, Fix and Improvement">
  <Changes type="added">
    - New Card component
...
<Release version="1.0.5" title="Add New Features and Improvement for this version">
  <Changes type="added">
...
<Release version="1.0.0" title="Initial release of DocuBook to create interactive nested docs with MDX">
  <Changes type="added">
